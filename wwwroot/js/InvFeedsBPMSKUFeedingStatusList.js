...
$(document).ready(function () {
  var table = $('#invFeedsBpmSKUFeedingStatusItems').DataTable();

  $('#invFeedsBpmSKUFeedingStatusItems tbody').on('click', 'tr', function () {
...
$("#updateInvFeedsBpmSKUStatusBtn").click(function () {
  var table = $('#invFeedsBpmSKUFeedingStatusItems').DataTable();
  const jsonArray = [];
  ...
  returnResult.customerId = customerID; // BPM Customer ID
...
function loadDataTable() {
  dataTable = $("#invFeedsBpmSKUFeedingStatusItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[3, "asc"]],
    ...
    "columns": [
      ...
      { "data": "lastModifiedTime", "width": "18%" }
    ],
    "language": {
  ...
  dataTable = $("#invFeedsBpmSKUFeedingConflictedItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
    ...
    "columns": [
      ...
      { "data": "lastModifiedBy", "width": "17%" },
      { "data": "lastModifiedTime", "width": "17%" }
    ],
    "language": {
      "emptyTable": "no data found"
    },
...
function getJSON(contents) {
 // const tmpCustId = $('#customerId').val();
  const custId = customerID; // BPM ID
