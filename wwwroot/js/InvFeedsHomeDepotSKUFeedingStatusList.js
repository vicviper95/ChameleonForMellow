...
$(function () {
  $("#homeDepotFeedingStatusTabs").tabs();
});



$(document).ready(function () {
  var table = $('#invFeedsHomeDepotSKUFeedingStatusItems').DataTable();

  invFeedsHomeDepotSKUFeedingStatusTable;
  invFeedsHomeDepotSKUFeedingConflictedTable;

  $('#invFeedsHomeDepotSKUFeedingStatusItems tbody').on('click', 'tr', function () {
...
$("#updateInvFeedsHomeDepotSKUStatusBtn").click(function () {
  var table = $('#invFeedsHomeDepotSKUFeedingStatusItems').DataTable();
  const jsonArray = [];
  ...
  $.ajax({
    ...
    success: function () {
      ...
      invFeedsHomeDepotSKUFeedingStatusTable.ajax.reload();
      invFeedsHomeDepotSKUFeedingConflictedTable.ajax.reload();
...
var invFeedsHomeDepotSKUFeedingStatusTable = $("#invFeedsHomeDepotSKUFeedingStatusItems").DataTable({
  "autoWidth": false,
  destroy: true,
  dom: 'Bfrtip',
  "order": [[3, "asc"]],
...
var invFeedsHomeDepotSKUFeedingConflictedTable = $("#invFeedsHomeDepotSKUFeedingConflictedItems").DataTable({
  "autoWidth": false,
  destroy: true,
  dom: 'Bfrtip',
  "order": [[4, "asc"]],
