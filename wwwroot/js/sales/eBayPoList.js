...
$('#eBay_Order thead tr')
    .clone(true)
    .addClass('filters')
    .appendTo('#eBay_Order thead');
let walmartPoTable = $("#eBay_Order").DataTable({
    "order": [[6, "desc"]],
    "autoWidth": false,
    orderCellsTop: true,
    fixedHeader: false,
    ...
    "ajax": {
        ...
        "dataSrc": function (res) {
            ...
            if (res.wmtLastSyncTime != null) {
                ...
                $("#lastSyncTime").html("Last eBay Sync Date: " + moment(lastSyncTime).format('MM/DD/YYYY hh:mm A'));
            }
            countDate = 0;
            countPrice = 0;
...
/*        { "data": "customer", "width": "10%" },*/
        { "data": "orderNo", "width": "5%" },
        { "data": "sku", "width": "5%" },
        { "data": "orderStatus", "width": "5%" },
        {
            "data": "date", type: "date", "width": "5%", render: function (data, type, row, meta) {
             return moment(data).format('YYYY/MM/DD');
            }
        },
        {
            "data": "shipDate", "width": "5%", render: function (data) {
                return moment(data).format('YYYY/MM/DD');
            }
        },
        {
            "data": "asnSentTime", "width": "10%", render: function (data) {
                if (data != null)
        ...
        { "data": "carrier", "width": "5%" },
        { "data": "wareHouse", "width": "5%" },
        { "data": "qty", "width": "1%" },
        {
            "data": "unitePrice", "width": "3%", render: function (data) {

                return "$" + data;
            }
        },
        {
            "data": "totalPrice", "width": "3%", render: function (data, type, row, meta) {
                return "$" + data;
            }
        },
        {
            "data": "addedTime", "width": "13%", render: function (data) {
                return moment(data).format('YYYY/MM/DD HH:mm A');
            }
        }
    ],
