...
$(function () {
  $("#wyfrFeedingStatusTabs").tabs();
});



$(document).ready(function () {
  var table = $('#invFeedsWyfrSKUFeedingStatusItems').DataTable();
  
  $('#invFeedsWyfrSKUFeedingStatusItems tbody').on('click', 'td', function () {
    //console.log("Here??!!");
    //var e, f;
    var d = table.row(this).data();
//    var t = table.cell(this).data();
    var s = table.cell(this).index().column;
   // console.log(d);
   // console.log(s);
  //  console.log(t);
    ...
    {
      if (d.wayfairCGStockRule == true) d.wayfairCGStockRule = false;
      else d.wayfairCGStockRule = true;
    }
    //if (d.feedsEnable == true) d.feedsEnable = false;
    //else d.feedsEnable = true;
...
$("#updateInvFeedsWyfrSKUStatusBtn").click(function () {
  var table = $('#invFeedsWyfrSKUFeedingStatusItems').DataTable();
  const jsonArray = [];
...
function loadDataTable() {
  dataTable = $("#invFeedsWyfrSKUFeedingStatusItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
  ...
  dataTable = $("#invFeedsWyfrSKUFeedingConflictedItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
    ...
    "columns": [
      ...
      { "data": "conflictType", "width": "14%" },
      { "data": "itemName", "width": "8%" },
      { "data": "itemStatus", "width": "5%" },
      { "data": "custSKU", "width": "8%" },
      { "data": "asin", "width": "8%" },
      { "data": "custUPC", "width": "8%" },
      { "data": "description", "width": "22%" },
      { "data": "lastModifiedBy", "width": "16%" },
      { "data": "lastModifiedTime", "width": "12%" }
    ],
    "language": {
      "emptyTable": "no data found"
