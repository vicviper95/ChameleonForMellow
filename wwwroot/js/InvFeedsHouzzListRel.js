...
$("#reloadHouzzFeedsHistory").click(function () {
  ...
  document.getElementById('historyDateHidden').value = historyDate;
  getInvFeedsReportDate();
  dataTable = $("#invFeedsHouzzItems").DataTable({
    destroy: true,
    dom: 'Bfrtip',
    ...
    buttons: [
      ...
      },
      {
        ...
        filename: function () {
          ...
          return "Houzz_" + todayDate + "_" + todatyTime;
        },
        exportOptions: {
          columns: ':visible'
        }
    ...
    "ajax": {
      "url": "/Inventory/GetHouzzInvFeeds",
      "type": "GET",
      "datatype": "json",
      "dataSrc": "",
      "data": function (d) {
    ...
    "columns": [
      { "data": "bpmSku", "width": "15%" },
      { "data": "houzzSku", "width": "15%" },
      { "data": "upc", "width": "15%" },
      { "data": "qty", "width": "15%" },
