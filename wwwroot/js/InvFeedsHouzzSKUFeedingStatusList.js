...
$(document).ready(function () {
  var table = $('#invFeedsHouzzSKUFeedingStatusItems').DataTable();

  $('#invFeedsHouzzSKUFeedingStatusItems tbody').on('click', 'tr', function () {
...
$("#updateInvFeedsHouzzSKUStatusBtn").click(function () {
  var table = $('#invFeedsHouzzSKUFeedingStatusItems').DataTable();
  const jsonArray = [];
...
function loadDataTable() {
  dataTable = $("#invFeedsHouzzSKUFeedingStatusItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[3, "asc"]],
  ...
  dataTable = $("#invFeedsHouzzSKUFeedingConflictedItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
