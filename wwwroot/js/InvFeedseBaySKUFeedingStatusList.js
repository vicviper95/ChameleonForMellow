...
$(function () {
  $("#eBayFeedingStatusTabs").tabs();
});



$(document).ready(function () {
  var table = $('#invFeedseBaySKUFeedingStatusItems').DataTable();

  $('#invFeedseBaySKUFeedingStatusItems tbody').on('click', 'tr', function () {
...
$("#updateInvFeedseBaySKUStatusBtn").click(function () {
  var table = $('#invFeedseBaySKUFeedingStatusItems').DataTable();
  const jsonArray = [];
...
function loadDataTable() {
  dataTable = $("#invFeedseBaySKUFeedingStatusItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[3, "asc"]],
  ...
  dataTable = $("#invFeedseBaySKUFeedingConflictedItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
