...
$(function () {
  $("#ostFeedingStatusTabs").tabs();
});



$(document).ready(function () {
  var table = $('#invFeedsOstSKUFeedingStatusItems').DataTable();

  $('#invFeedsOstSKUFeedingStatusItems tbody').on('click', 'tr', function () {
...
$("#updateInvFeedsOstSKUStatusBtn").click(function () {
  var table = $('#invFeedsOstSKUFeedingStatusItems').DataTable();
  const jsonArray = [];
...
function loadDataTable() {
  dataTable = $("#invFeedsOstSKUFeedingStatusItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[3, "asc"]],
  ...
  dataTable = $("#invFeedsOstSKUFeedingConflictedItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
