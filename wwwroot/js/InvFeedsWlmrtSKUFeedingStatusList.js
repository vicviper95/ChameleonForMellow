...
$(function () {
  $("#wlmrtFeedingStatusTabs").tabs();
});



$(document).ready(function () {
  var table = $('#invFeedsWlmrtSKUFeedingStatusItems').DataTable();

  $('#invFeedsWlmrtSKUFeedingStatusItems tbody').on('click', 'tr', function () {
...
$("#updateInvFeedsWlmrtSKUStatusBtn").click(function () {
  var table = $('#invFeedsWlmrtSKUFeedingStatusItems').DataTable();
  const jsonArray = [];
...
function loadDataTable() {
  dataTable = $("#invFeedsWlmrtSKUFeedingStatusItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[3, "asc"]],
  ...
  dataTable = $("#invFeedsWlmrtSKUFeedingConflictedItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
    ...
    "columns": [
      ...
      { "data": "conflictType", "width": "10%" },
      { "data": "itemName", "width": "7%" },
      { "data": "itemStatus", "width": "7%" },
      { "data": "custSKU", "width": "7%" },
      { "data": "custUPC", "width": "7%" },
      { "data": "asin", "width": "7%" },
      { "data": "description", "width": "24%" },
      { "data": "lastModifiedBy", "width": "16%" },
      { "data": "lastModifiedTime", "width": "10%" }
    ],
    "language": {
      "emptyTable": "no data found"
    },
