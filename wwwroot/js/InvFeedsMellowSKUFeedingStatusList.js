...
$(function () {
  $("#mellowFeedingStatusTabs").tabs();
});



$(document).ready(function () {
  var table = $('#invFeedsMellowSKUFeedingStatusItems').DataTable();

  $('#invFeedsMellowSKUFeedingStatusItems tbody').on('click', 'tr', function () {
...
$("#updateInvFeedsMellowSKUStatusBtn").click(function () {
  var table = $('#invFeedsMellowSKUFeedingStatusItems').DataTable();
  const jsonArray = [];
  ...
  returnResult.customerId = customerID; // Mellow
...
function loadDataTable() {
  dataTable = $("#invFeedsMellowSKUFeedingStatusItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[3, "asc"]],
  ...
  dataTable = $("#invFeedsMellowSKUFeedingConflictedItems").DataTable({
    "autoWidth": false,
    destroy: true,
    dom: 'Bfrtip',
    "order": [[4, "asc"]],
